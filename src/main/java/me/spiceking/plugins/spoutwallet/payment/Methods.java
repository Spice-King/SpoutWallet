package me.spiceking.plugins.spoutwallet.payment;
...
public class Methods {
     ...
     */
    private void _init() {
        this.addMethod("iConomy", new me.spiceking.plugins.spoutwallet.payment.methods.iCo6());
        this.addMethod("iConomy", new me.spiceking.plugins.spoutwallet.payment.methods.iCo5());
        this.addMethod("iConomy", new me.spiceking.plugins.spoutwallet.payment.methods.iCo4());
        this.addMethod("BOSEconomy", new me.spiceking.plugins.spoutwallet.payment.methods.BOSE6());
        this.addMethod("BOSEconomy", new me.spiceking.plugins.spoutwallet.payment.methods.BOSE7());
        this.addMethod("Essentials", new me.spiceking.plugins.spoutwallet.payment.methods.EE17());
        this.addMethod("MultiCurrency", new me.spiceking.plugins.spoutwallet.payment.methods.MCUR());
    }
